#!/usr/bin/python3
"""
    This module that ins a Rectangle class with
...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """ This method initialize a new instance """
    ...
    def __str__(self):
        """ This method to return the string representation """
    ...
    def __repr__(self):
        """
            This method to the return the string representation
    ...
    def __del__(self):
        """ This methid calls when an instance is being deleted """
    ...
    @property
    def width(self):
        """ This method get the width property """

        return self.__width

    @width.setter
    def width(self, value):
        """ This method set the width property """
