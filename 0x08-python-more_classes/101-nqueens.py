#!/usr/bin/python3
"""
    This is a module that contains the algorithm that resolves the
    N-Queen puzzle using backtracking
"""


def isSafe(m_queen, nqueen):
    """ ethod that determines if the queens can or can't kill each other """
...
def print_result(m_queen, nqueen):
    """ This method that prints the list with the Queens positions """
...
def Queen(m_queen, nqueen):
    """ This recursive method that executes the Backtracking algorithm """
...
def solveNQueen(size):
    """ This method that invokes the Backtracking algorithm """
